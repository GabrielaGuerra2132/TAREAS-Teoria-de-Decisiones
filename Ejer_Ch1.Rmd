...
```{r}
ggplot(Mode)+
  geom_density(aes(cost.car),color="black", fill="orange")+
  geom_density(aes(cost.carpool),color="black", fill="red")+
  geom_density(aes(cost.bus),color="black", fill="blue")+
  geom_density(aes(cost.rail),color="black", fill="cyan")+
  theme_bw()
```
```{r}
ggplot(Mode)+
  geom_density(aes(time.car),color="black", fill="orange", alpha=0.4)+
